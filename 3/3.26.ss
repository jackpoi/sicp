#|
https://sicp.readthedocs.io/en/latest/chp3/26.html
2/lib/tree.ss
2/lib/tree-set.ss
|#
...
(define phone-tree (tree-insert! '() 'peter 1382000 compare-symbol))
(display (tree-search phone-tree 'peter compare-symbol)) (newline)

(define phone-tree (tree-insert! phone-tree 'jack 137234234 compare-symbol))
(display phone-tree) (newline)

(define phone-tree (tree-insert! phone-tree 'sam 1579898 compare-symbol))
(display phone-tree) (newline)
